...
<main class="page-main">
  <section class="page-main__important-news important-news">
    <div class="important-news__container">
      <h2 class="news__title">Объявления</h2>
        ...
        <li class="important-news__item">
          <a href="<?php the_permalink(); ?>" class="important-news__link">
            ...
            <div class="important-news__link-container">
              ...
              <time class="important-news__date" datetime=""><?php the_time('j F Y') ?></time>
              <?php the_excerpt(); ?>
              <button class="important-news__button">Смотреть объявление</button>
            </div>
          </a>
        </li>
    ...
    <div class="poster-container">
      ...
      <div class="poster__item">
        <a href="<?php the_permalink(); ?>" class="poster__link">
          <div class="poster__link-container">
            <h3 class="poster__title"><?php the_title(); ?></h3>
            <time class="poster__date" datetime=""><?php the_time('j F Y') ?></time>
            <?php the_excerpt(); ?>
          </div>
          <?php the_post_thumbnail('thumbnail' , array('class' => "poster__img")); ?>
        </a>
      </div>
  ...
  <section class="page-main__educational-focus educational-focus">
    <div class="educational-focus__container">
      <h2 class="educational-focus__title">Образовательные направленности</h2>
  ...
  <section class="page-main__news news">
    <div class="news__container">
      ...
      <ul class="news__list">
        ...
        <li class="news__item">
          ...
          <span class="news__view">Смотреть новость</span>
    ...
    <div class="button__all-news__container">
    <a class="button button__all-news" href="https://detsport-ob.ru/category/event">Все новости</a>
    </div>
    </div>
  </section>
  ...
  <section class="page-main__pages-links pages-links">
    ...
    <h2 class="news__title">Полезные ссылки</h2>
  ...
  <section class="page-main__trash trash">
    <div class="trash__container">
      <div class="trash__item" style="display: none;">
      <script src='https://pos.gosuslugi.ru/bin/script.min.js'></script>
        ...
        <div class="radius-10" id='js-show-iframe-wrapper'>
          <div class='pos-banner-fluid bf-20'>
            <div class='bf-20__decor'>
              <div class='bf-20__logo-wrap' style="border-radius: 10px;"> <img class='bf-20__logo'
                  src='https://pos.gosuslugi.ru/bin/banner-fluid/gosuslugi-logo-blue.svg' alt='Госуслуги' />
                <div class='bf-20__slogan'>Решаем вместе</div>
              </div>
            </div>
            <div class='bf-20__content'>
              <div class='bf-20__text'> Есть предложения по организации учебного процесса или знаете, как сделать школу
                лучше? </div>
              <div class='bf-20__bottom-wrap'>
                <div class='bf-20__btn-wrap'>
                  <!-- pos-banner-btn_2 не удалять; другие классы не добавлять --> <button class='pos-banner-btn_2'
                    type='button'>Написать о проблеме </button> </div>
              </div>
            </div>
          </div>
        </div>
        <script>
          (function () {
            ...
            var POS_PREFIX_20 = "--pos-banner-fluid-20__",
            ...
            function changePosBannerOnResize() {
              var e = document.documentElement,
                t = _objectSpread({}, posOptionsInitialBanner20),
              ...
              if (o > 568) t["grid-template-columns"] = "1fr 292px", t["grid-template-rows"] = "100%", t[
                  "content-grid-row"] = "1", t["content-padding"] = "32px 24px", t["bg-url-position"] =
                "calc(100% + 35px) bottom";
              ...
              if (o > 1098) t["bg-url"] =
                "url('https://pos.gosuslugi.ru/bin/banner-fluid/18/banner-fluid-bg-18-3.svg')", t["bg-url-position"] =
                "calc(100% + 55px) bottom", t["grid-template-columns"] = "1fr 557px", t["text-font-size"] = "32px", t[
                  "content-padding"] = "32px 32px 32px 50px", t["logo-width"] = "78px", t["slogan-font-size"] =
                "15px", t["logo-wrap-padding"] = "20px 16px 16px";
              if (o > 1422) t["max-width"] = "1422px", t["grid-template-columns"] = "1fr 720px", t[
                  "content-padding"] = "32px 48px 32px 160px", t.background =
                "linear-gradient(90deg, #f8b200 50%, #f8efec 50%)";
              setStyles(t, e)
            }
            changePosBannerOnResize(), window.addEventListener("resize", changePosBannerOnResize), window.onunload =
              function () {
                var e = document.documentElement,
                  t = _objectSpread({}, posOptionsInitialBanner20);
        ...
        <script>
          Widget("https://pos.gosuslugi.ru/form", 293811)
        </script>
      </div>
