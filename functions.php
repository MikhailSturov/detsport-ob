...
function my_custom_init(){
	register_post_type('educational', array(
		'labels'             => array(
			'name'               => 'Образовательные направленности', // Основное название типа записи
			'singular_name'      => 'Образовательная направленность', // отдельное название записи типа Book
			'add_new'            => 'Добавить новую',
			'add_new_item'       => 'Добавить новую направленность',
			'edit_item'          => 'Редактировать направленность',
			'new_item'           => 'Новая образовательная направленность',
			'view_item'          => 'Посмотреть образовательную направленность',
			'search_items'       => 'Найти образовательную направленность',
			'not_found'          => 'Образовательных направленностей не найдено',
			'not_found_in_trash' => 'Не найдено',
			'parent_item_colon'  => '',
			'menu_name'          => 'Образовательные направленности'
	...
	register_post_type('teachers', array(
		'labels'             => array(
			'name'               => 'Педагогический состав', // Основное название типа записи
			'singular_name'      => 'Педагог', // отдельное название записи типа Book
			'add_new'            => 'Добавить',
			'add_new_item'       => 'Добавить педагога',
			'edit_item'          => 'Редактировать',
			'new_item'           => 'Новый педагог',
			'view_item'          => 'Посмотреть информацию',
			'search_items'       => 'Найти педагога',
			'not_found'          => 'Педагогов не найдено',
			'not_found_in_trash' => 'Не найдено',
			'parent_item_colon'  => '',
			'menu_name'          => 'Педагогический состав'
	...
	register_post_type('administration', array(
		'labels'             => array(
			'name'               => 'Руководство', // Основное название типа записи
			'singular_name'      => 'Руководитель', // отдельное название записи типа Book
			'add_new'            => 'Добавить',
			'add_new_item'       => 'Добавить руководителя',
			'edit_item'          => 'Редактировать',
			'new_item'           => 'Новый руководитель',
			'view_item'          => 'Посмотреть информацию',
			'search_items'       => 'Найти руководителя',
			'not_found'          => 'Руководителей не найдено',
			'not_found_in_trash' => 'Не найдено',
			'parent_item_colon'  => '',
			'menu_name'          => 'Руководство'
...
function theme_register_nav_menu() {
	...
	register_nav_menu( 'side', 'Боковое меню в разделе "Сведения об ОО"' );
